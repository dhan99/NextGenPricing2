  ...
  if (!open) {
    return (
      <button
        ...
        className="fixed top-1/2 -translate-y-1/2 right-6 z-40 flex items-center gap-2 px-3.5 py-2.5 rounded-full bg-primary text-primary-foreground shadow-lg hover:bg-primary/90 transition-all"
